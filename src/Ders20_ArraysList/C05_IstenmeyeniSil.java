...
public class C05_IstenmeyeniSil {
    public static void main(String[] args) {
        ...
        // harf iceren elementleri silip, kalan kismini
        // list olarak bize donduren bir method olusturun
    ...
    private static List<String> istenmeyenHarfIcerenleriSil(List<String> liste, String istenmeyenHarf) {


        // for loop ile elementleri ele alirken remove
        // yaparsak list in uzunlugu degisecegi icin sorun yasariz
        // farkli bir list olusturup, silinmeyecekleri yeni
        // listeye kaydedelim
