...
public class C01_PassByValue {
    public static void main(String[] args) {
        ...
        // elementleri artir metodunu calistirdiktan sonra
        System.out.println("element artir metodundan sonra : " + sayilar);
    ...
    public static void elementleriArtir(List <Integer> sayilar){
        ...
        System.out.println("elementleri artir metodunda : " + sayilar);
    }
