...
public class C09_varargsDikkatEdilecekler {
    public static void main(String[] args) {
        ...
        // sonra toplam ile ilk sayiyi carpip yazdirsın
        topla(2,3,4,5,6,7);
        ...
        /* Dikkat edilecekler -2
         ...
         bundan oturu bir method da parametre olarak varargs
         kullanılacaksa EN SON parametre olarak kullanilmalidir.

         Dikkat edilecekler -3

         bir methodda parametre olarak 2 varargs KULLANILAMAZ
    ...
    varargs ın yapisindan dolayi int a, int ...b ile int ...b
    ...
    */
    ...
    public static void  topla(int c, int... a ){
        ...
        System.out.println("Istenen islem sonucu : " + toplam*c); // Istenen islem sonucu : 50
    }
}
